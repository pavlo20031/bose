...
function changeImg(mode) {
  if (mode === 'black') {
    console.log('b');
    f.srcset = '/img/dekstop/products-black-des@1x.webp 1x, /img/dekstop/products-black-des@2x.webp 2x ';
    s.srcset = '/img/tablet/products-black-tablet@1x.webp 1x, /img/tablet/products-black-tablet@2x.webp 2x ';
    t.srcset = '/img/mobile/products-black-mobile@1x.webp 1x, /img/mobile/products-black-mobile@2x.webp 2x ';
